package ac.id.atmaluhur.mahasiswa_2011520012;
...
import ac.id.atmaluhur.mahasiswa_2011520012.ui.api.ApiClient;
import ac.id.atmaluhur.mahasiswa_2011520012.ui.api.ApiService;
import ac.id.atmaluhur.mahasiswa_2011520012.ui.hospital.HospitalFragment;
import ac.id.atmaluhur.mahasiswa_2011520012.ui.model.ListLocationModel;
import ac.id.atmaluhur.mahasiswa_2011520012.ui.model.LocationModel;
import ac.id.atmaluhur.mahasiswa_2011520012.ui.restaurant.RestaurantFragment;
import ac.id.atmaluhur.mahasiswa_2011520012.ui.school.SchoolFragment;
...
public class MainActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void school(){
        ...
        getAllDataLocationLatLng("school");
    ...
    private void getAllDataLocationLatLng(String m){
        ...
        if(m.equalsIgnoreCase("school")){
            call = apiService.getSchool();
        }else if(m.equalsIgnoreCase("restaurant")){
            call = apiService.getRestaurant();
        }else if(m.equalsIgnoreCase("hospital")){
